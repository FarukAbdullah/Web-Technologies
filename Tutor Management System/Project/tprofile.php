...
if(isset($_SESSION["valid"]) && $_SESSION["valid"]=="yes"){
	if(isset($_COOKIE["email"])){
		...
		$sql1="select * from thsc where email='".$_COOKIE["email"]."'";
		loadFromMySQL1($sql1);

		$sql2="select * from tbsc where email='".$_COOKIE["email"]."'";
		loadFromMySQL2($sql2);

		$sql3="select * from tmsc where email='".$_COOKIE["email"]."'";
		loadFromMySQL3($sql3);

		$sql4="select * from tutorpersonalinfo where email='".$_COOKIE["email"]."'";
		loadFromMySQL4($sql4);

		$sql5="select * from tutorotherinfo where email='".$_COOKIE["email"]."'";
		loadFromMySQL5($sql5);
	}
	else 
	{
...
?>
<h3><a style="text-decoration: none" href="tutorindex.php">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration: none" href="logout.php">Log out</a></h3>
