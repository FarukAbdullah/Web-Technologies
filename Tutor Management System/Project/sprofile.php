...
if(isset($_SESSION["valid"]) && $_SESSION["valid"]=="yes"){
	if(isset($_COOKIE["email"])){
		...
		$sql1="select * from stueducationinfo where email='".$_COOKIE["email"]."'";
		loadFromMySQL1($sql1);
...
?>
<h3><a style="text-decoration: none" href="studentindex.php">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration: none" href="logout.php">Log out</a></h3>
