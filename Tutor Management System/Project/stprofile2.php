...
if(isset($_SESSION["valid"]) && $_SESSION["valid"]=="yes"){
	if(isset($_COOKIE["email"])){
		...
		$sql="select * from stupersonalinfo where email='".$_REQUEST["sender"]."'";
		loadFromMySQL($sql);

		$sql1="select * from stueducationinfo where email='".$_REQUEST["sender"]."'";
		loadFromMySQL1($sql1);
...
while($c=fgets($file)){
	$ar=explode(" ",$c);
	if($_REQUEST["sender"]==$ar[0]){
		$proPicURL=$ar[1];
	}
}

?>
<h3><a style="text-decoration: none" href="request.php">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration: none" href="tutorindex.php">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="text-decoration: none" href="logout.php">Log out</a></h3>
...
<h3><a style="text-decoration: none" href="tselect.php?sender=<?php echo $_REQUEST["sender"];?>"><?php echo "Select" ?></a></h3>
</td></tr>
    <br><br>
